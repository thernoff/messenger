        ...
        .then((res) =>
            {
                if (res.data){
                    ...
                    UserStore.setInfoMessage({status: 'error', text: 'Ошибка: Пользователь с таким логином уже существует.'});
                }
            }
        )
        .catch(err =>
        ...
        .then((res) =>
            {
                if (res.data){
                    ...
                    UserStore.setInfoMessage({status: 'error', text: 'Ошибка: Неверный логин или пароль.'});
                }
            }
        )
        .catch(err =>
